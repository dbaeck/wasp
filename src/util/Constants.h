 ...
 */
#define NO_QUERY 0
#define ENUMERATION_ALGORITHM 1
#define MODELBASED_ALGORITHM 2
#define ITERATIVE_ALGORITHM 3
#define UNDERESTIMATE_INCREASE_ALGORITHM 4
#define UNDERESTIMATE_INC_NOFIRSTMODEL_ALGORITHM 5
